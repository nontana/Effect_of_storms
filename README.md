# Effect_of_storms
This project is part of Reproducible Research course project 2 in Coursera.

The detail of data processing and results are included in the file `Data_processing.pdf` or [RPubs](https://rpubs.com/nontana/C_RR_course_project2).
